...
FunctionDescriptor *Profile::addFunction(const string &name, const string &object, const string &file)
{
    FunctionDescriptor *newFunctionDescriptor = new FunctionDescriptor(name, object, file);
